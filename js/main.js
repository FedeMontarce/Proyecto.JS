...
document.getElementById("form").addEventListener("submit", function (event) {
  ...
  emailjs.sendForm(serviceID, templateID, this).then(
    () => {
      btn.value = "Sumbit";
      Swal.fire("Reserva realizada!", "Gracias por elegirnos!", "success");
    },
    (err) => {
      btn.value = "Sumbit";
...
if (localStorage.getItem(`guardarReserva`) !== null) {
  ...
  reserva = Swal.fire({
    title:
      'Bienvenidos a "El Timón", un lugar especializado en comida Argentina. Si desea reservar una mesa complete el formulario que se encuentra en la parte inferior de la pagina',
    showClass: {
